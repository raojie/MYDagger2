 ...
 */
package com.raoj.dagger.presentation.view.component;
...
public class AutoLoadImageView extends ImageView {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR =
                new Creator<AutoLoadImageView.SavedState>() {
                    public AutoLoadImageView.SavedState createFromParcel(Parcel in) {
                        return new AutoLoadImageView.SavedState(in);
                    }

                    public AutoLoadImageView.SavedState[] newArray(int size) {
                        return new AutoLoadImageView.SavedState[size];
                    }
                };
    }
}